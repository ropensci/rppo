...
#' This is how I got the data for the different filtersthat can be used when
#' doing a query. Can put it in a function because the way I get the webpage
#' doesn't work if I do for some reason. Can't use regular webscrapping because
#' the data generated by the angular.js isn't in the wource code.
